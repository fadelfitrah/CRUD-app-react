  ...
  return (
    <DashboardLayout>
      <PageHeader
        ...
        subtitle="Tambahkan event baru ke dalam sistem"
      >
        <Button
          onClick={handleBack}
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Berikan nama dan kategori event yang jelas
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl bg-green-50 p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-slate-800">Tanggal & Jam</h3>
                <p className="mt-1 text-sm text-slate-600">
                  Tentukan waktu pelaksanaan event
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl bg-purple-50 p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-slate-800">Gambar Event</h3>
                <p className="mt-1 text-sm text-slate-600">
